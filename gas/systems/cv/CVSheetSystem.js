        ...
        try {
          ...
          const requestBody = {
            ...
            messages: [
              {
                role: 'system',
                content: 'あなたは建築・リフォーム業界の案件メモを整理するアシスタントです。以下のルールを厳守してください：\n1. 整理した内容のみを出力し、タイトル（「案件メモ整理」等）や説明文（「この形式で～」等）は一切付けない\n2. 重要な情報は残し、冗長な表現は簡潔にする\n3. 箇条書きで整理し、そのまま業者に転送できる形式にする\n4. 余計な挨拶や補足説明は不要'
              },
              {
                role: 'user',
                content: '以下の案件メモを整理してください。整理結果のみを出力し、タイトルや説明文は付けないでください：\n\n' + memo
              }
            ],
            temperature: 0.3,
            max_tokens: 1000
