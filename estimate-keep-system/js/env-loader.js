...
const ENV = {
  ...
  // プライマリGAS URL（メイン運用）- V1458: Image position fix - Use transform translate() instead of object-position
  GAS_URL: 'https://script.google.com/macros/s/AKfycbwC01wWhb-r1c_KufsDwvW2FS1LYHJNT9EJ5-k3yTD3717UmrIvQinFoDejj4_RQEIATQ/exec',
  ...
  // キャッシュバスター（🔥一箇所管理🔥）
  CACHE_BUSTER: '2025-10-30T02:25:00-V1458-POSITION-FIX'
};
