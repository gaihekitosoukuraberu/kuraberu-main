...
<<<<<<< HEAD
  // キャッシュバスター（V1943 - 履歴表示分離+架電ワークフロー改善）
  CACHE_BUSTER: 'v1764409896-fe56bbbc'
=======
  // キャッシュバスター（V1944 - 架電履歴保存修正+テストボタン）
  CACHE_BUSTER: 'v1764409317-v1944'
>>>>>>> f12c3ae3 (V1944: 架電履歴保存を確実化+テストボタン追加)
};
