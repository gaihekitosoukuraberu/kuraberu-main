...
const MerchantSystem = {
  ...
  getDeliveredCases: function(params) {
    try {
      ...
      console.log('[MerchantSystem] getDeliveredCases - 加盟店ID:', merchantId);
      ...
      console.log('[MerchantSystem] getDeliveredCases - 取得件数:', deliveredCases.length);
      ...
      console.error('[MerchantSystem] getDeliveredCases error:', error);
      return {
        success: false,
        error: error.toString()
      };
  ...
  submitContractReport: function(params) {
    try {
      ...
      console.log('[MerchantSystem] submitContractReport - CV ID:', cvId, '加盟店ID:', merchantId);
      ...
      console.log('[MerchantSystem] submitContractReport - 成約報告完了:', cvId);
      ...
      console.error('[MerchantSystem] submitContractReport error:', error);
      return {
        success: false,
        error: error.toString()
      };
